<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="成绩" prop="chengji">
          <el-input v-model="ruleForm.chengji" 
              placeholder="成绩" clearable  :readonly="ro.chengji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="成绩" prop="chengji">
              <el-input v-model="ruleForm.chengji" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="申诉原因" prop="shensuyuanyin">
          <el-input v-model="ruleForm.shensuyuanyin" 
              placeholder="申诉原因" clearable  :readonly="ro.shensuyuanyin"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="申诉原因" prop="shensuyuanyin">
              <el-input v-model="ruleForm.shensuyuanyin" 
                placeholder="申诉原因" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.chengji = true;
          ...
          if(o=='shensuyuanyin'){
            this.ruleForm.shensuyuanyin = obj[o];
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `chengjishensu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.chengjishensuCrossAddOrUpdateFlag = false;
                  this.parent.search();

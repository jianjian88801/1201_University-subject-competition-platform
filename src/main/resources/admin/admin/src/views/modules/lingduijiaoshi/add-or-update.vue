<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="教工号" prop="jiaogonghao">
          <el-input v-model="ruleForm.jiaogonghao" 
              placeholder="教工号" clearable  :readonly="ro.jiaogonghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="教工号" prop="jiaogonghao">
              <el-input v-model="ruleForm.jiaogonghao" 
                placeholder="教工号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="专业领域" prop="zhuanyelingyu">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.zhuanyelingyu" label="专业领域" prop="zhuanyelingyu">
                    <span>{{ruleForm.zhuanyelingyu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xingbie = true;
          ...
          if(o=='jiaogonghao'){
            this.ruleForm.jiaogonghao = obj[o];
	    this.ro.jiaogonghao = true;
            continue;
          }
          if(o=='xueyuan'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `lingduijiaoshi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.lingduijiaoshiCrossAddOrUpdateFlag = false;
                  this.parent.search();

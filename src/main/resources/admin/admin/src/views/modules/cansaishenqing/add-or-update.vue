<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="竞赛内容" prop="jingsaineirong">
          <el-input v-model="ruleForm.jingsaineirong" 
              placeholder="竞赛内容" clearable  :readonly="ro.jingsaineirong"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="竞赛内容" prop="jingsaineirong">
              <el-input v-model="ruleForm.jingsaineirong" 
                placeholder="竞赛内容" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="竞赛时间" prop="jingsaishijian">
          <el-input v-model="ruleForm.jingsaishijian" 
              placeholder="竞赛时间" clearable  :readonly="ro.jingsaishijian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="竞赛时间" prop="jingsaishijian">
              <el-input v-model="ruleForm.jingsaishijian" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="队名" prop="duiming">
          <el-input v-model="ruleForm.duiming" 
              placeholder="队名" clearable  :readonly="ro.duiming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="队名" prop="duiming">
              <el-input v-model="ruleForm.duiming" 
                placeholder="队名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="作品" prop="zuopin">
          <file-upload
          tip="点击上传作品"
          action="file/upload"
          :limit="1"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.zuopin" label="作品" prop="zuopin">
            <el-button type="text" size="small" @click="download(ruleForm.zuopin)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="参赛成员" prop="cansaichengyuan">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="参赛成员"
                  v-model="ruleForm.cansaichengyuan" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.cansaichengyuan" label="参赛成员" prop="cansaichengyuan">
                    <span>{{ruleForm.cansaichengyuan}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="预算" prop="yusuan">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="预算"
                  v-model="ruleForm.yusuan" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.yusuan" label="预算" prop="yusuan">
                    <span>{{ruleForm.yusuan}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="项目" prop="xiangmu">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="项目"
                  v-model="ruleForm.xiangmu" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.xiangmu" label="项目" prop="xiangmu">
                    <span>{{ruleForm.xiangmu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jibie = true;
          ...
          if(o=='duiming'){
            this.ruleForm.duiming = obj[o];
	    this.ro.duiming = true;
            continue;
          }
          if(o=='cansaichengyuan'){
            this.ruleForm.cansaichengyuan = obj[o];
	    this.ro.cansaichengyuan = true;
            continue;
          }
          if(o=='yusuan'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `cansaishenqing/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.cansaishenqingCrossAddOrUpdateFlag = false;
                  this.parent.search();

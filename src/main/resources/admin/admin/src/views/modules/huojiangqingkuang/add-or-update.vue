<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="获奖金额" prop="huojiangjine">
          <el-input v-model="ruleForm.huojiangjine" 
              placeholder="获奖金额" clearable  :readonly="ro.huojiangjine"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="获奖金额" prop="huojiangjine">
              <el-input v-model="ruleForm.huojiangjine" 
                placeholder="获奖金额" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="获奖明细" prop="huojiangmingxi">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="获奖明细"
                  v-model="ruleForm.huojiangmingxi" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.huojiangmingxi" label="获奖明细" prop="huojiangmingxi">
                    <span>{{ruleForm.huojiangmingxi}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.renshu = true;
          ...
          if(o=='huojiangjine'){
            this.ruleForm.huojiangjine = obj[o];
	    this.ro.huojiangjine = true;
            continue;
          }
          if(o=='huojiangmingxi'){
            this.ruleForm.huojiangmingxi = obj[o];
	    this.ro.huojiangmingxi = true;
            continue;
          }
          if(o=='beizhu'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `huojiangqingkuang/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.huojiangqingkuangCrossAddOrUpdateFlag = false;
                  this.parent.search();

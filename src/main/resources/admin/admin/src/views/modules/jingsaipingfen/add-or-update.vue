  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.cansaichengyuan = true;
          ...
          if(o=='zuopinpingfen'){
            this.ruleForm.zuopinpingfen = obj[o];
	    this.ro.zuopinpingfen = true;
            continue;
          }
          if(o=='pingjianeirong'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `jingsaipingfen/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jingsaipingfenCrossAddOrUpdateFlag = false;
                  this.parent.search();

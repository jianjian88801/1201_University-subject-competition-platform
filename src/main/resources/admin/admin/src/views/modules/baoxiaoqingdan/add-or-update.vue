<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="参赛成员" prop="cansaichengyuan">
          <el-input v-model="ruleForm.cansaichengyuan" 
              placeholder="参赛成员" clearable  :readonly="ro.cansaichengyuan"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="参赛成员" prop="cansaichengyuan">
              <el-input v-model="ruleForm.cansaichengyuan" 
                placeholder="参赛成员" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="经费预算" prop="jingfeiyusuan">
          <el-input v-model="ruleForm.jingfeiyusuan" 
              placeholder="经费预算" clearable  :readonly="ro.jingfeiyusuan"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="经费预算" prop="jingfeiyusuan">
              <el-input v-model="ruleForm.jingfeiyusuan" 
                placeholder="经费预算" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="参赛费用" prop="cansaifeiyong">
          <el-input v-model="ruleForm.cansaifeiyong" 
              placeholder="参赛费用" clearable  :readonly="ro.cansaifeiyong"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="参赛费用" prop="cansaifeiyong">
              <el-input v-model="ruleForm.cansaifeiyong" 
                placeholder="参赛费用" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.cansaichengyuan = true;
          ...
          if(o=='jingfeiyusuan'){
            this.ruleForm.jingfeiyusuan = obj[o];
	    this.ro.jingfeiyusuan = true;
            continue;
          }
          if(o=='cansaifeiyong'){
            this.ruleForm.cansaifeiyong = obj[o];
	    this.ro.cansaifeiyong = true;
            continue;
          }
          if(o=='wenjian'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `baoxiaoqingdan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.baoxiaoqingdanCrossAddOrUpdateFlag = false;
                  this.parent.search();

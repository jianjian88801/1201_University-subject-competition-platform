<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="竞赛总结" prop="jingsaizongjie">
          <el-input v-model="ruleForm.jingsaizongjie" 
              placeholder="竞赛总结" clearable  :readonly="ro.jingsaizongjie"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="竞赛总结" prop="jingsaizongjie">
              <el-input v-model="ruleForm.jingsaizongjie" 
                placeholder="竞赛总结" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.cansaichengyuan = true;
          ...
          if(o=='jingsaizongjie'){
            this.ruleForm.jingsaizongjie = obj[o];
	    this.ro.jingsaizongjie = true;
            continue;
          }
          if(o=='wenjian'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `jingsaizongjie/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jingsaizongjieCrossAddOrUpdateFlag = false;
                  this.parent.search();

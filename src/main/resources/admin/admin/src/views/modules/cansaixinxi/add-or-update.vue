<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="学校" prop="xuexiao">
          <el-input v-model="ruleForm.xuexiao" 
              placeholder="学校" clearable  :readonly="ro.xuexiao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="学校" prop="xuexiao">
              <el-input v-model="ruleForm.xuexiao" 
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="作品特色" prop="zuopintese">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="作品特色"
                  v-model="ruleForm.zuopintese" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zuopintese" label="作品特色" prop="zuopintese">
                    <span>{{ruleForm.zuopintese}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zuopin = true;
          ...
          if(o=='zuopintese'){
            this.ruleForm.zuopintese = obj[o];
	    this.ro.zuopintese = true;
            continue;
          }
        }
      }
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `cansaixinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.cansaixinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
